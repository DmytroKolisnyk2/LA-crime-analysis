...
```{r}
# Перегляд структури кожного датасету
glimpse(arrest_data)
glimpse(crime_data)
glimpse(calls_data)

# Перетворення дат і фільтрація записів за 2020 рік
...
# Перегляд фільтрованих даних
glimpse(arrest_data)
glimpse(crime_data)
glimpse(calls_data)

# Додавання колонок для ідентифікації джерела даних
...
# Виведення об'єднаних даних (лише перші 20 рядків)
cat("Перші 20 записів об'єднаного датасету:\n")
print(head(combined_data, 20))

# Перегляд структури об'єднаних даних
